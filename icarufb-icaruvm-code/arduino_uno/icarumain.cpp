...
icr_uint8 convertOperand(Operand *o, icr_uint8 type)
{
    switch(type)
    {
    case CONV_INT2REAL:
	...
	if(code_pointer < 65500){
		...
		switch(code_pointer){
			...
			case 65506:
				...
				break;
      case 65509:
        FB_LCD_MSG(mem_index+4);
        break;
      case 65510:
        FB_SD_CARD_WRITE(mem_index+4);
        break;
      case 65511:
        FB_ANALOG_READ(mem_index+4);
        break;
      case 65512:
        FB_MILLIS(mem_index+4);
        break;
		}
